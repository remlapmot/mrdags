...
if (packageVersion('DiagrammeR') < '1.0.11') stop('Re-install DiagrammeR from CRAN')
```
...
```{r}
remotes::install_github('timelyportfolio/DiagrammeR')
```
...
Reinstall CRAN version of DiagrammeR (in case used as a dependency by any code below).
