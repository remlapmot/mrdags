...
```{tikz, iv-bw, fig.width=3, engine.opts=list(template = "tikz-template-swig-tr.tex"), out.width='50%'}
\begin{tikzpicture}
...
```{tikz, iv-color, fig.width=3, engine.opts=list(template = "tikz-template-swig-tr.tex"), out.width='50%'}
\begin{tikzpicture}
\tikzset{line width=1.5pt, outer sep=0pt,
  ell/.style={draw, fill=white, inner sep=2pt,
  line width=1.5pt},
...
```{tikz, mvmr-pleiotropy, fig.width=3, engine.opts=list(template = "tikz-template-swig-tr.tex"), out.width='50%'}
\begin{tikzpicture}
\tikzset{line width=1.5pt, outer sep=0pt,
  ell/.style={draw, fill=white, inner sep=2pt,
  line width=1.5pt},
