...
DiagrammeR::grViz("
      ...
      node [shape=ellipse]
      U [label='Confounders', pos='2,1!']

      node [shape=box]
      G1 [label='Genotype@_{1}', pos='0,1!']
      G2 [label='Genotype@_{2}', pos='0,0!']
      G3 [label='Genotype@_{3}', pos='0,-1!']
      X [label='Phenotype', pos='1,0!']
      Y [label='Outcome', pos='3,0!']
