...
We can produce some nice plots with the quickdag package from [here](https://github.com/jrgant/quickdag)
...
We can also draw the single world intervention graph for the IV model as follow.
```{r}
# SWiG
swig <- dag %>%
