...
# Note: the dylib from homebrew (brew install ghostscript) did not work when run through Quarto
# Using advice from Andrew Heiss blogpost
# https://www.andrewheiss.com/blog/2021/08/27/tikz-knitr-html-svg-fun/#connecting-dvisvgm-to-ghostscript-on-macos
# So installed the .pkg from Richard Koch 
