---
title: "R, DOT, and TikZ code to plot DAGs and SWIGs for Mendelian randomization analyses"
author: "Tom Palmer"
date: "`r Sys.Date()`"
---
...
For a bidirectional MR analysis we can combine the 2 separate DAGs into a single figure as follows.
...
DiagrammeR::grViz("
      ...
      node [shape=plaintext, height=0.3, width=0.3]
      GX [label='Genotypes for phenotype', pos='0,0!']
      X [label='Phenotype', pos='2,0!']
      Y [label='Outcome', pos='4,0!']
      GY [label='Genotypes for outcome', pos='6,0!']
...
```{r}
if (!requireNamespace("quickdag", quietly = TRUE)) {
