...
# The libgs.dylib from Homebrew (brew install ghostscript) did not work when run through Quarto
# This is because it was only for arm64, whereas the one below includes both architectures arm64 and x86_64
# either the LIBGS environment variable or the --libgs flag.
# The libgs.dylib from Homebrew (brew install ghostscript) did not work when
# run through Quarto.
# This is because it was only for arm64, whereas the one below includes both
# architectures arm64 and x86_64.
# Installing the Ghostscript .pkg from Richard Koch
# https://pages.uoregon.edu/koch/
# During the installation click customise and select the dynamic library
if (Sys.info()[["sysname"]] == "Darwin") {
  Sys.setenv(LIBGS = "/usr/local/lib/libgs.9.56.dylib")
}
```
